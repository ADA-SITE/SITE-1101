...
<figure style="margin: 1em 0; text-align: center;">
  <img src="../../assets/images/signature.png" alt="ALT TEXT" style="max-width: 80%; height: auto;">
...
Do not click REPLY ALL when your reply concerns only the sender. Use REPLY instead. Learn to make proper use of forwarding an email when necessary. See the official [Microsoft instructions](https://support.microsoft.com/en-au/office/reply-to-or-forward-an-email-message-a843f8d3-01b0-48da-96f5-a71f70d0d7c8) on the matter. You can also flag or pin important emails if you wish.
