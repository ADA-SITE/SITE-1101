...
The Syllabus document with more details will be shared on Blackboard. Note that both the document and this website can be updated throughout the semester. Any disrepancies should be resolved by [asking a question](../../general/communication) on Blackboard Discussion page.

## Schedule

| Day | Time  | 10425 | 10426 | 10428 | 10429 | 10430 | 11225 |
|-----|-------|-------|-------|-------|-------|-------|-------|
| Mon | 08:30 | E125  | E125  | E125  | E125  | E125  | E125  |
| Tue | 08:30 | B302  |       |       |       |       |       |
| Tue | 13:00 |       |       |       |       | B102  |       |
| Thu | 08:30 |       | B302  |       |       |       |       |
| Thu | 13:00 |       |       |       |       |       | B201  |
...
| 3 | Digital vs Analog / Data Units / Number Systems / Binary Arithmetic / Two’s Complement / Transistors / Boolean Logic | Compare digital and analog systems. Define bit, byte, and data units. Convert numbers between decimal, binary, and hexadecimal. Explain binary addition, subtraction, and two’s complement. Describe Boolean logic, truth tables, transistors, and logic gates. | **Project 1 out [Team]:** Constructing basic logic gates using transistors and other electronic components |
| 4 | Hardware: CPU, GPU, Memory, I/O, Storage | Explain von Neumann architecture. Describe CPU components and operation. Explain GPU purpose. Differentiate memory types (ROM, RAM, cache), DRAM vs SRAM, and secondary storage technologies. | — |
...
| 10 | World Wide Web / Markup Languages / Cloud Computing / System Architectures | Describe WWW structure and HTTP. Explain URLs. Describe markup languages. Explain cloud computing models and centralized vs decentralized systems. | — |
...
| 12 | DBMS / SQL / NoSQL / Transactions / ACID / CAP | Explain DBMS types and purposes. Describe data manipulation operations. Explain SQL commands. Contrast SQL and NoSQL. Explain transactions, ACID properties, and CAP theorem. | **Project 4 out [Individual]:** Building personal portfolio website |
